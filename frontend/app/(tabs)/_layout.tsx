      ...
      <Tabs
        screenOptions={{
          ...
          tabBarItemStyle: {
            ...
            paddingTop: 10, // Slight optical adjustment
            paddingBottom: 10,
          },
        }}
      >
        ...
        <Tabs.Screen
          ...
          options={{
            ...
            tabBarIcon: ({ color, focused }) => (
              ...
              focused ? { backgroundColor: theme.primary, elevation: 4 } : {}
              ]}>
                <Ionicons name={focused ? 'mic' : 'mic-outline'} size={24} color={focused ? 'white' : color} />
              </View>
            ),
            tabBarLabelStyle: { display: 'none' } // Hide label for cleaner look
          }}
        />
        <Tabs.Screen
          name="stock"
